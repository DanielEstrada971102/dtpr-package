...
The CMS DTs geometry information is stored in an XML file (`DTGeometry.xml <https://github.com/DanielEstrada971102/dtpr-package/blob/main/dtpr/utils/templates/DTGeometry.xml>`_). 
...
.. autoclass:: dtpr.geometry.DTGeometry
    :members: get
...
.. autoclass:: dtpr.geometry.DTFrame
    :members:
